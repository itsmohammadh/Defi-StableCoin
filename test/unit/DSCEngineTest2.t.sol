...
contract DSCEngineTest is StdCheats, Test {
    ...
    function testRevertsIfTransferFromFails() public {
        ...
        vm.expectRevert(DSCEngine.DSCEngine__transferFaild.selector);
    ...
    function testRevertsIfMintedDscBreaksHealthFactor() public {
        ...
        uint256 expectedHealthFactor =
            dsce.calculateHelathFactor(amountToMint, dsce.getUsdValue(weth, amountCollateral));
    ...
    function testRevertsIfMintFails() public {
        ...
        vm.expectRevert(DSCEngine.DSCEngine__MintFaild.selector);
    ...
    function testMustImproveHealthFactorOnLiquidation() public {
        ...
        vm.expectRevert(DSCEngine.DSCEngine__HElathFactorNotImproved.selector);
    ...
    function testUserStillHasSomeEthAfterLiquidation() public liquidated {
        uint256 amountLiquidated = dsce.getTokenAmountFromUsd(weth, amountToMint) // Get how much WETH the user lost
            + (dsce.getTokenAmountFromUsd(weth, amountToMint) / dsce.getLiquidationBonus());
